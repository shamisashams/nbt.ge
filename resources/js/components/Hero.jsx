            ...
            <div className="wrapper h-full flex md:items-center items-end justify-between relative">
                <div>
                    <div className="bold hidden md:block">
                        <BsArrowDownCircle className="text-2xl mb-1 mr-2" />{" "}
                        {__("client.socials", localizations)}
                    </div>
                    <div
                        style={{ height: "29vh" }}
                        className=" hidden md:block bg-white w-px my-4 ml-3 opacity-70"
                    ></div>
                ...
                {sliders.map((item, index) => {
                    return (
                        ...
                        >
                            <img
                                src={
                                    item.logo ? item.logo.thumb_full_url : null
                                }
                                alt=""
                            />
