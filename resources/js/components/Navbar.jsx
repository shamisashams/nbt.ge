...
const Navbar = () => {
    ...
    const { localizations, locales, currentLocale, locale_urls, categories } =
        usePage().props;
        ...
        >
            <div className="wrapper flex items-start justify-between ">
                <Link
                    ...
                    className="pt-3 relative md:-ml-36 -ml-16"
                >
                    <img
                        className="md:w-auto w-44"
                        src={
                            dark
                                ? "/client/assets/images/logo/2.png"
                                : "/client/assets/images/logo/1.png"
                        }
                        alt=""
                    />
                    <div
