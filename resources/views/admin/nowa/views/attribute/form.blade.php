                                ...
                                <table id="options">
                                    ...
                                    @foreach($attribute->options as $item)
                                        <tr>
                                            ...
                                            @if($attribute->code == 'brand')
                                                <td>
                                                    <input type="file" name="options[{{$item->id}}][image]">
                                                    @if($item->image)
                                                        <img src="{{asset('storage/'.$item->image)}}" height="80">
                                                    @endif
                                                </td>
                                            @endif
                                            @if($attribute->code !== 'corner')
...
@section('scripts')
    ...
    <script>
        ...
        $('#add_option_btn').click(function (){
            ...
            if(attribute.code === 'brand')tr.append('<td><input type="file" name="options[option_'+ ind +'][image]"></td>')
