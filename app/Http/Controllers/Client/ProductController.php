...
//            "locale" => App::getLocale()
    ...
    public function show(string $locale, string $slug)
    {
        ...
        $productImages = $product->gallery()->orderBy('id','desc')->get();
        ...
        $similar_products = Product::where(['status' => 1, 'product_categories.category_id' => $path[0]['id']])
            ...
            ->inRandomOrder()
            ->groupBy('products.id')
            ->with(['latestImage','translation','attribute_values.attribute.translation','attribute_values.option.translation'])->limit(15)->get();
...
//            "locale" => App::getLocale()
    ...
    public function getProducts($locale,Category $category){
        ...
        $query->with(['latestImage','translation']);
        $query->limit(15);
        $query->inRandomOrder();
